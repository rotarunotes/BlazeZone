fammi il promtp per farmi in output il file per il custom file explorer sort: che modifichi nel vault l'ordine per:
- Ogni README deve essere all'inizio di ogni ogni cartella, sopra a tutti i file e cartelle
- Poi il file system principare deve essere così:
	- README
	- Puzzle_Of_Knowledge
	- Red_Lab
	- School
...
- Poi ho impostato bene gli appunti di un argomento: Puzzle_Of_Knowledge/Computer_Science/System_And_Networks
e vorrei che sia organizzato bene in questo modo:
