...
IPv4 è il protocollo di rete usato per identificare dispositivi su una rete tramite indirizzi a **32 bit**, scritti in notazione decimale puntata (es. `192.168.1.1`).
