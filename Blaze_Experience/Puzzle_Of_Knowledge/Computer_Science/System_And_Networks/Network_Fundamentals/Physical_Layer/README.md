...
___
# Physical_Layer
Il **Livello Fisico** rappresenta le fondamenta dell'intero modello ISO/OSI. Il suo unico compito è la **trasmissione dei bit** (0 e 1) da un dispositivo all'altro attraverso un mezzo fisico.
3 aspetti:
