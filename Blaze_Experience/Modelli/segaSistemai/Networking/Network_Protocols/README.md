...
___
# Indice
- [HTTP](Modelli/segaSistemai/Networking/Network_Protocols/HTTP.md)
...
- [NTP](Modelli/segaSistemai/Networking/Network_Protocols/NTP.md)
- [SNMP](Modelli/segaSistemai/Networking/Network_Protocols/SNMP.md)
...
| **POP3**  | Post Office Protocol v3             | Downloads emails to a local device and removes them from the server. |
